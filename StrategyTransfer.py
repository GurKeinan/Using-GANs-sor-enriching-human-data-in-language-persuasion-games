...
import argparse
from train_GAN import LSTMGenerator, StupidDiscriminator  # I added this import
...
# TODO: Our features
parser.add_argument('--GAN_simulations', type=float, default=0.5, help='The ratio of GAN simulations to true human simulations')
parser.add_argument('--generator_repetitions', type=int, default=40, help='The number of times the generator is repeated compared to the discriminator')
parser.add_argument('--generate_best_out_of', type=int, default=5, help='The number of generated samples from which we will choose for training the one the discriminator confused at the most')
parser.add_argument('--retrain_GAN', type=str2bool, default=False, help='Whether to retrain the GAN or not')
...
try:
    ...
    duration = 2000  # 1000 ms or 1 second
